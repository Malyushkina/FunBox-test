...
В планах JS – хочу серьёзно разобраться, параллельно с середины октября курс «Введение в бэкенд» (node.js), python3.0, БД. Дальше – библиотеки, фреймворки.

С уважением Евгения Малюшкина
